    ...
    <div class="container">
        ...
        <?php if ($menu_data): ?>
            <form action="" method="POST" enctype="multipart/form-data">
                <input type="text" name="menu_name" value="<?php echo $menu_data['menu_name']; ?>" required>
                <textarea name="description" required><?php echo $menu_data['description']; ?></textarea>
                <input type="number" name="price" value="<?php echo $menu_data['price']; ?>" required>
